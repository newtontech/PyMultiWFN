# A script to calculate RESP2 charges by invoking ORCA and Multiwfn
# Written by Tian Lu (sobereva@sina.com)
# Last update: 2022-Mar-8
# Examples:
...
### Run optimization under solvent
echo
echo Running optimization task under solvent via ORCA...
