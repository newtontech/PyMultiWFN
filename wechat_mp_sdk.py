...
class WeChatMediaPlatform:
    ...
    def _log(self, message: str, level: str = "INFO"):
        ...
        log_file = os.path.join(self.log_dir, f"wechat_{datetime.now().strftime('%Y%m%d')}.log")
    ...
    def batch_get_material(self, material_type: str = "image", offset: int = 0, 
        ...
        Returns:
            素材列表响应
        """
        self._log(f"批量获取素材 - type: {material_type}, offset: {offset}, count: {count}")
    ...
    def upload_news_material(self, file_path: str, title: str, 
                            author: str, digest: str, content_source_url: str,
    ...
    def upload_img(self, file_path: str) -> Dict[str, Any]:
        ...
        with open(file_path, 'rb') as f:
            ...
            # 上传
            return self._make_request("UPLOAD", endpoint, data=data, files=files, use_json=False)
...
def create_article(title: str, author: str, digest: str, content: str, 
                   content_source_url: str, thumb_media_id: str) -> Dict[str, Any]:
    """
    创建图文消息文章
