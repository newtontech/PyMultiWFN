...
class FeishuDocClient:
    ...
    def _log(self, message: str, level: str = "INFO"):
        ...
        log_file = os.path.join(self.log_dir, f"feishu_{datetime.now().strftime('%Y%m%d')}.log")
    ...
    def _make_request(self, method: str, endpoint: str, data: Optional[Dict] = None, 
                   params: Optional[Dict] = None, files: Optional[Dict] = None) -> Any:
        """发送API请求"""
    ...
    def list_documents(self, space_id: str, page_size: int = 50, page_token: str = "") -> Dict[str, Any]:
        """
        查看文档列表
    ...
    def get_document(self, document_id: str, obj_type: str = "docx", 
                   obj_basic: bool = True) -> Dict[str, Any]:
        """
        读取文档内容
    ...
    def create_document(self, space_id: str, title: str, content: str, 
                       folder_token: str = "") -> Dict[str, Any]:
        """
        创建新文档
    ...
    def update_document(self, document_id: str, obj_type: str = "docx", 
    ...
    def delete_document(self, document_id: str, obj_type: str = "docx") -> Dict[str, Any]:
        """
        删除文档
...
def main():
    ...
    if not config.get('app_id') or not config.get('app_secret') or not config.get('tenant_id'):
        print("请配置飞书应用凭证:")
        print()
    ...
    while True:
        ...
        if choice == "0":
            ...
            try:
                ...
                if result.get('code') == 0:
                    doc_id = result.get('data', {}).get('document', {}).get('document_id', 'N/A')
