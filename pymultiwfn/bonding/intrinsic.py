...
def calculate_intrinsic_bond_order(
    ...
    polarity = calculate_bond_polarity(
        element_i, element_j, density_matrix, overlap_matrix,
        atom_i_indices, atom_j_indices
    )
    ...
    for i in range(n_atoms):
        ...
        for j in range(i + 1, n_atoms):
            ...
            ibo, polarity, wiberg = calculate_intrinsic_bond_order(
                density_matrix, wfn.overlap_matrix,
                element_i, element_j, bfs_i, bfs_j
            )
