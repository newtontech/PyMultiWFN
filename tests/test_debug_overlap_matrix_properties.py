...
def test_simplified_version():
    """测试简化版本的功能与原版一致"""
    # 加载原始文件和简化文件
    original_file = Path(__file__).parent / 'debug_overlap_matrix_properties'
    simplified_file = Path(__file__).parent / 'debug_overlap_matrix_properties.simplified.py'
    ...
    print(f"✅ 改进：{original_lines - simplified_lines} 行（-{1 - simplified_lines/original_lines*100:.1f}%）")
