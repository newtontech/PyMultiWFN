...
class TestDelocalizationIndexClass:
    ...
    def test_get_bond_type(self, simple_h2_wfn):
        ...
        assert bond_type in ["weak", "single", "aromatic", "double", "triple", "very_strong"]
...
def simple_h3_wfn():
    ...
    shells = [
        Shell(type=0, center_idx=0, exponents=np.array([1.0]), coefficients=np.array([1.0])),
        Shell(type=0, center_idx=1, exponents=np.array([1.0]), coefficients=np.array([1.0])),
        Shell(type=0, center_idx=2, exponents=np.array([1.0]), coefficients=np.array([1.0])),
    ]
...
def benzene_wfn():
    ...
    for i in range(6):
        shells.append(
            Shell(type=0, center_idx=i, exponents=np.array([1.0]), coefficients=np.array([1.0]))
        )
